return {
    ...
    misc = {
        dictionary = {
            ...
            jmix_jazz = "Jazz",
            jmix_soul = "Soul",
            jmix_neosoul = "Neo-Soul",
            jmix_electronic = "Electronic",
            jmix_rock = "Rock",
            jmix_pop = "Pop",
            jmix_folk = "Folk",
            jmix_hiphop = "Hip-Hop",
            ...
            jmix_metal = "Metal",
            jmix_funk = "Funk",
            jmix_country = "Country",
            jmix_experimental = "Experimental",

            --UI
            jmix_comma_spacer = ', ',
            jmix_genres = 'Genres: ',
            jmix_year = 'Release Year: ',

            --General
            k_jmix_mashup_pack = "Mashup Pack",
            k_jmix_rearrange_ex = 'Rearrange!'
        }
    }
}
